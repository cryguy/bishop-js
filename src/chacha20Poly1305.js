// taken from js-umbral@1.0.8 - https://unpkg.com/js-umbral@1.0.8/src/chacha20Poly1305.js


/* chacha20 - 256 bits */

// adapted/modified from https://gist.github.com/rumkin/e852eb12fe11281a5738c0a8abaf5e1a
// by damon@nucypher.com
...
function aeadEncrypt(key, nonce, plaintext, data) {
    ...
    const mac = aead_mac(polykey, data, ciphertext)
    const result = new Uint8Array(mac.length + ciphertext.length)
